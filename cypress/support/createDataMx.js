...
function generarValoresAleatorios() {
  return {
    email: `emailtest.${generarNumeroAleatorio(1, 100000)}@cypress.mx`,
    nombre: faker.name.firstName(),
    apellido: faker.name.lastName(),
    //numbre: numberFake
    number: ('1010'+ numeroAleatorioString),
    password : 'P@ssword01'
  }
}
...
fs.writeFile('cypress/fixtures/dataEmail.json', jsonValores, 'utf8', (err) => {
  if (err) {
